...
export const seedTrips: Trip[] = [
  {
    ...
    visibility: "family",
    destinationName: "Island",
    destinationCity: null,
    destinationRegion: null,
    destinationCountryName: "Island",
    destinationCountryCode: "IS",
    destinationLatitude: 64.9631,
    destinationLongitude: -19.0208,
    destinationExternalId: null,
    description: "Ein entspannter Roadtrip zwischen Wasserfällen, heißen Quellen und schwarzen Stränden.",
    highlights: ["Golden Circle", "Südküste", "Blaue Lagune"],
    coverPhotoUrl: demoCoverPhotos.iceland,
